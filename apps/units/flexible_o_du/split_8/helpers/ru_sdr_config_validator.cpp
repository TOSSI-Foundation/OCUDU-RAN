                                      ...
                                      span<const ru_sdr_cell_validation_config> cell_config)
{
  ...
  if (discontinuous_transmission && is_simulation_driver(config.device_driver)) {
    fmt::print("Discontinuous transmission modes cannot be used with simulation drivers.\n");
